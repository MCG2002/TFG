...
image_path = "../../../dataset/manifest/CBIS-DDSM/YOLO/images/val/Mass_Test_P_01912_RIGHT_MLO.png"
label_path = "../../../dataset/manifest/CBIS-DDSM/YOLO/labels/val/Mass_Test_P_01912_RIGHT_MLO.txt"

...
image_path = "../../../dataset/manifest/CBIS-DDSM/YOLO/images/val/Mass_Test_P_00758_LEFT_MLO.png"
label_path = "../../../dataset/manifest/CBIS-DDSM/YOLO/labels/val/Mass_Test_P_00758_LEFT_MLO.txt"

...
image_path = "../../../dataset/manifest/CBIS-DDSM/YOLO/images/val/Mass_Test_P_01800_LEFT_CC.png"
label_path = "../../../dataset/manifest/CBIS-DDSM/YOLO/labels/val/Mass_Test_P_01800_LEFT_CC.txt"

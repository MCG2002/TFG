from tumor_classification.models.utils_models import EarlyStoppingCallback, plot_loss_acc
from tumor_classification.models.regularizationl1l2.regularizationl1l2_augmentation_model import model_with_l1l2_and_aug
